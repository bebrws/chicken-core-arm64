...
if(C_unlikely(!C_demand_2(568))){
C_save(t1);
C_rereclaim2(568*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
...
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\002\001qs\376\001\000\000\022\001chicken.process#qs\376\003\000\000\002\376\003\000\000\002\376\001\000\000\006\001system\376\001\000\000\026\001chicken.pr"
...
{C_text("f_128:chicken_2eprocess_2eimport_2escm"),(void*)f_128},
