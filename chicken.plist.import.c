/* Generated from chicken.plist.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   Version 5.2.0 (rev 317468e4)
   macosx-unix-clang-x86-64 [ 64bit dload ptables ]
   command line: chicken.plist.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -no-warnings -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.plist.import.c
...
lf[1]=C_h_intern(&lf[1],13, C_text("chicken.plist"));
lf[2]=C_h_intern(&lf[2],7, C_text("library"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\003\001get\376\001\000\000\021\001chicken.plist#get\376\003\000\000\002\376\003\000\000\002\376\001\000\000\016\001get-properties\376\001\000\000\034\001ch"
...
{C_text("f_117:chicken_2eplist_2eimport_2escm"),(void*)f_117},
{C_text("f_120:chicken_2eplist_2eimport_2escm"),(void*)f_120},
{C_text("f_123:chicken_2eplist_2eimport_2escm"),(void*)f_123},
{C_text("f_126:chicken_2eplist_2eimport_2escm"),(void*)f_126},
{C_text("f_128:chicken_2eplist_2eimport_2escm"),(void*)f_128},
{C_text("toplevel:chicken_2eplist_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
