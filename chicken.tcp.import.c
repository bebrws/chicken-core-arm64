/* Generated from chicken.tcp.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   Version 5.2.0 (rev 317468e4)
   macosx-unix-clang-x86-64 [ 64bit dload ptables ]
   command line: chicken.tcp.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -no-warnings -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.tcp.import.c
...
lf[1]=C_h_intern(&lf[1],11, C_text("chicken.tcp"));
lf[2]=C_h_intern(&lf[2],3, C_text("tcp"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\011\001tcp-close\376\001\000\000\025\001chicken.tcp#tcp-close\376\003\000\000\002\376\003\000\000\002\376\001\000\000\012\001tcp-listen\376\001"
...
{C_text("f_117:chicken_2etcp_2eimport_2escm"),(void*)f_117},
{C_text("f_120:chicken_2etcp_2eimport_2escm"),(void*)f_120},
{C_text("f_123:chicken_2etcp_2eimport_2escm"),(void*)f_123},
{C_text("f_126:chicken_2etcp_2eimport_2escm"),(void*)f_126},
{C_text("f_128:chicken_2etcp_2eimport_2escm"),(void*)f_128},
{C_text("toplevel:chicken_2etcp_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
