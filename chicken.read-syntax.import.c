/* Generated from chicken.read-syntax.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   Version 5.2.0 (rev 317468e4)
   macosx-unix-clang-x86-64 [ 64bit dload ptables ]
   command line: chicken.read-syntax.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -no-warnings -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.read-syntax.import.c
...
lf[1]=C_h_intern(&lf[1],19, C_text("chicken.read-syntax"));
lf[2]=C_h_intern(&lf[2],11, C_text("read-syntax"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\017\001copy-read-table\376\001\000\000#\001chicken.read-syntax#copy-read-table\376\003\000\000\002\376\003\000"
...
{C_text("f_117:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)f_117},
{C_text("f_120:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)f_120},
{C_text("f_123:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)f_123},
{C_text("f_126:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)f_126},
{C_text("f_128:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)f_128},
{C_text("toplevel:chicken_2eread_2dsyntax_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
