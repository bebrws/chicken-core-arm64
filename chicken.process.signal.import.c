...
if(C_unlikely(!C_demand_2(748))){
C_save(t1);
C_rereclaim2(748*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
C_initialize_lf(lf,5);
lf[0]=C_h_intern(&lf[0],30, C_text("##sys#register-compiled-module"));
lf[1]=C_h_intern(&lf[1],22, C_text("chicken.process.signal"));
lf[2]=C_h_intern(&lf[2],5, C_text("posix"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\012\001set-alarm!\376\001\000\000!\001chicken.process.signal#set-alarm!\376\003\000\000\002\376\003\000\000\002\376\001\000\000\023"
...
{C_text("f_117:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)f_117},
{C_text("f_120:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)f_120},
{C_text("f_123:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)f_123},
{C_text("f_126:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)f_126},
{C_text("f_128:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)f_128},
{C_text("toplevel:chicken_2eprocess_2esignal_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
