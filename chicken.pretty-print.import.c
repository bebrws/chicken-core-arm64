/* Generated from chicken.pretty-print.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   Version 5.2.0 (rev 317468e4)
   macosx-unix-clang-x86-64 [ 64bit dload ptables ]
   command line: chicken.pretty-print.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -no-warnings -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.pretty-print.import.c
...
if(C_unlikely(!C_demand_2(88))){
C_save(t1);
C_rereclaim2(88*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
C_initialize_lf(lf,5);
lf[0]=C_h_intern(&lf[0],30, C_text("##sys#register-compiled-module"));
lf[1]=C_h_intern(&lf[1],20, C_text("chicken.pretty-print"));
lf[2]=C_h_intern(&lf[2],6, C_text("extras"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\002\001pp\376\001\000\000\027\001chicken.pretty-print#pp\376\003\000\000\002\376\003\000\000\002\376\001\000\000\014\001pretty-print\376\001\000\000!"
...
{C_text("f_117:chicken_2epretty_2dprint_2eimport_2escm"),(void*)f_117},
{C_text("f_120:chicken_2epretty_2dprint_2eimport_2escm"),(void*)f_120},
{C_text("f_123:chicken_2epretty_2dprint_2eimport_2escm"),(void*)f_123},
{C_text("f_126:chicken_2epretty_2dprint_2eimport_2escm"),(void*)f_126},
{C_text("f_128:chicken_2epretty_2dprint_2eimport_2escm"),(void*)f_128},
{C_text("toplevel:chicken_2epretty_2dprint_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
